...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1682** we call complete: **854 agree**, **68 contradicted**, 749 ambiguous — **647 of them diagnosed and 102 held by name since the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **36 s** |
