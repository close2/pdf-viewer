...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1688** we call complete: **858 agree**, **68 contradicted**, 751 ambiguous — **all 786 diagnosed and 0 held by name, from 754 in the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **47 s** |
...
| conformance | **507 quotations**, all verbatim, **4986 citations**, 208 distinct tables cited by the tree, **875 ledger rows** | `-p conformance` |
