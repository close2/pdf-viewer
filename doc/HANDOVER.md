...
cargo nextest run --workspace              # 1337 tests, 9 ignored. A user-local install:
...
cargo test --workspace --doc               # the one doctest nextest does not run: 1337 + 1 = 1338
