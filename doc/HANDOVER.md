...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1685** we call complete: **856 agree**, **68 contradicted**, 750 ambiguous — **778 of the 786 diagnosed and 8 held by name since the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **36 s** |
...
| conformance | **465 quotations**, all verbatim, 4475 citations, 195 distinct tables cited by the tree, **875 ledger rows** | `-p conformance` |
