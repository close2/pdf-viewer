...
| conformance | **445 quotations**, all verbatim, 4407 citations, 195 distinct tables cited by the tree, **875 ledger rows** | `-p conformance` |
...
ADR 0206. **Annex I.2 came out of the same read and was paid the round after**: the file's version
