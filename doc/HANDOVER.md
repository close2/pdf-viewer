...
key with `pdf_model::x509` and verifies with `pdf_model::pkcs1` — RFC 8017's RSASSA-PKCS1-v1_5, in
tree, no dependency taken and none needed (ADR 0229). The sentences the program uses keep every
