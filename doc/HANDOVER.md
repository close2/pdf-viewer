...
| conformance | **489 quotations**, all verbatim, **4824 citations**, 206 distinct tables cited by the tree, **875 ledger rows** | `-p conformance` |
...
| `partial` | 247 | some are; the note says which are not |
...
cargo test -p conformance -- --nocapture   # 4824 citations, 489 quotations, 206 tables, 875 rows
