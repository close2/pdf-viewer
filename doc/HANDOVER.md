...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1686** we call complete: **857 agree**, **68 contradicted**, 750 ambiguous — **all 786 diagnosed and 0 held by name, from 754 in the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **47 s** |
