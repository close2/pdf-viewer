...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1685** we call complete: **856 agree**, **68 contradicted**, 750 ambiguous — **734 of the 786 diagnosed and 52 held by name since the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **36 s** |
| text (vs `pdftotext`, same 974) | **99.1%** of the reference's words (23 638 of 23 841), **27** named below the 0.90 floor — from 98.2% and 36 in the three-hundred-and-twenty-sixth session, when §9.10.2's second method reached Type 3 fonts (see below). The two figures before those were 22 931 of 23 349, and before *them* 22 970 of 23 390 for at least two sessions, which is a denominator nothing in this tree produces | `tests/text_extraction.rs`, ~30 s |
...
all 1794), and until the hundred-and-seventy-sixth session no gate watched one of them.** **52** are
