...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1686** we call complete: **857 agree**, **68 contradicted**, 750 ambiguous — **781 of the 786 diagnosed and 5 held by name since the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **36 s** |
...
| conformance | **479 quotations**, all verbatim, **4610 citations**, 195 distinct tables cited by the tree, **875 ledger rows** | `-p conformance` |
...
all 1794), and until the hundred-and-seventy-sixth session no gate watched one of them.** **5** are
...
went 754 → 5 undiagnosed and 781 pages carry a diagnosis; *eleven defects nobody could see* is
the number to watch.
