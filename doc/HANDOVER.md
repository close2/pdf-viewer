...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1678** we call complete: **851 agree**, **68 contradicted**, 748 ambiguous — **48 of them diagnosed and 712 held by name since the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **30 s** |
...
**The 80 incomplete documents**: fonts (fewest since session 6 — session 156's `CMap`s took 15 off
