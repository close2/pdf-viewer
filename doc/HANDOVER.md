...
| [`doc/traps/instruments-and-reports.md`](traps/instruments-and-reports.md) | runs a gate, believes a number, adds a report — **and any round that writes Rust at all**, for trap 7 | 7, 10, 10a, 11 |
