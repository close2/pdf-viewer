...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1685** we call complete: **856 agree**, **68 contradicted**, 750 ambiguous — **728 of the 786 diagnosed and 58 held by name since the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **36 s** |
...
| status | rows | |
|---|---|---|
| `implemented` | 386 | every normative requirement in the clause is executed |
| `partial` | 229 | some are; the note says which are not |
...
all 1794), and until the hundred-and-seventy-sixth session no gate watched one of them.** **58** are
