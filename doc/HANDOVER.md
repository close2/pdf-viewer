...
- **Percentiles at exit** — median, p90, max and sum for every stage, by nearest rank, plus the
  `elsewhere` inside `Device::render` that its three named phases do not cover.
