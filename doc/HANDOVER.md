...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1682** we call complete: **856 agree**, **68 contradicted**, 749 ambiguous — **668 of them diagnosed and 81 held by name since the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **36 s** |
...
all 1794), and until the hundred-and-seventy-sixth session no gate watched one of them.** 81 are
