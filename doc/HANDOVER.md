...
| [`doc/traps/the-interactive-loop.md`](traps/the-interactive-loop.md) | turns a press into a command, converts between the page's space, the display list's and the raster's, answers the core about a render, waits on a toolkit's loop, or writes that a toolkit cannot do something | 12a, 17, 19, 20, 21 |
