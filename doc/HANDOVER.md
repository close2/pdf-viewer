...
| oracle (1794 pages vs poppler, mupdf, ghostscript) | of **1685** we call complete: **856 agree**, **68 contradicted**, 750 ambiguous — **730 of the 786 diagnosed and 56 held by name since the hundred-and-seventy-sixth** (§3a) — 9 not comparable, 2 a reference's geometry | `tests/oracle.rs`, **36 s** |
...
all 1794), and until the hundred-and-seventy-sixth session no gate watched one of them.** **56** are
