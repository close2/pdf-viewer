...
| | item | corpus |
|---|---|---|
| [00](00-ambiguous-bucket.md) | Empty the oracle's ambiguous bucket, page by page | 492 pages |
| [01](01-ledger-partial-rows.md) | Read the ledger's 238 `partial` rows against the code | — |
...
| [13](13-a-selection-costs-a-layer-a-quad.md) | A selection costs a compositor layer a quad, and the window stops answering | every document with text |
...
| [25](25-view-dependent-annotations.md) | Table 197's two unraised triggers; `/FixedPrint`, which waits on printing | 15 |
