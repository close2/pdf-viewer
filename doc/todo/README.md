...
| [13](13-the-transfer-function.md) | §10.5's `/TR` — applied to solid colours and image samples, **not to a shading's**, and §11.7.5.2's per-region model is not built; both are reported and the file prices what is left |
