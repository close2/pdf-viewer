...
| [36](36-a-retrieval-api.md) | Retrieve the standard from the standard: `doc/md/` is used for clause existence and verbatim quotation, not line numbers. Three gaps, and the CLI/pipe/REST shapes are not equivalent | — |
