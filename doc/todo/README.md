...
| [44](44-what-trace-cannot-see.md) | `--trace` localises a slow frame and cannot attribute it: one number over four stages, the accessibility publication inside it, and no clock — raised from a Windows trace | — |
