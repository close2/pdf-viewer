...
| [12](12-the-device-comes-up-under-cpu.md) | `--cpu` brings a graphics device up anyway, so a driver that crashes during bring-up crashes a run that asked for the processor — reported from Windows | — |
