...
| [24](24-image-sampling-intent.md) | Carry an image *and its sampling intent* to the backends — the vocabulary is built, the mask is on it (ADR 0210) and JPEG 2000's resolution level is taken (ADR 0321); `render-gpu`'s sampled shading is the rest |
