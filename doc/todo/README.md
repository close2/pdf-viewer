...
| [48](48-the-specification-we-check-against.md) | `doc/md/` dropped every annotation, and the census found the annotations are the **errata** — 11 462 in ISO 32000-2, 434 strikeouts over 4038 words. **All 79 known passages read** (`doc/errata-read.md`), and two clauses turned out to be implemented from retired text: §12.5.2's `/BM`, ignored on every stored appearance stream, and §14.13.5's property-list key. Correcting the checker's whitespace-blind comparison took the list from 79 to **151**; 55 distinct passages left to read | — |
