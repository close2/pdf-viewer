...
| [14](14-stream-the-decompression.md) | **Road D**, first of the three the owner ordered out of `10`: stream the decompression so a bomb never becomes an allocation — the producer half is already written (ADR 0343), what a round owes first is the measurement (ADR 0354 re-priced it) |
