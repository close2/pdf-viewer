...
| [54](54-what-quorras-answer-asked.md) | Four residues from reading quorra's own account of where it stands against this tree, three of them ours alone: a refusal list that flattens a device refusal and two of ours, two censuses that are one corpus walk, the fifth-frame tile-cache loss, and the two lanes' differing sets. Four of their asks are discharged and struck out with what discharged them — the newest being type 4's comparison operators, where §7.10.5.2's *deferral* to a normative document turned out to state the type restriction this tree had been coercing past in silence (ADR 0412) |
