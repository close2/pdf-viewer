...
| [48](48-the-specification-we-check-against.md) | `doc/md/` dropped every annotation and has been caught losing content three times — 882 `/Annots` in ISO 32000-2 alone, all fourteen documents tagged. Census first | — |
