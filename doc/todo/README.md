...
| [05](05-an-instrument-for-the-interactive-surface.md) | An instrument for the interactive surface — the gates measure a raster and the work had moved off it. All three are built (ADRs 0333, 0334, 0342) and the first one's verdict *gates* (ADR 0421), its numbers having held across rounds, which is the rule that file exists to keep; what is left is the other counts' ratchets and each item's named remainder |
