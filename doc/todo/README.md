...
| [22](22-variable-text-edges.md) | §12.7.4.3's remaining edges: the Arabic free text value, refused whole — read, priced and pinned; and a `/DA` font name §7.3.5 makes bytes, whose fix is one decision with the `#xx` escaping this module's writer does not do (ADRs 0337, 0348, 0439) |
