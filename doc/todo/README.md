...
| [48](48-the-specification-we-check-against.md) | `doc/md/` dropped every annotation, and the census found the annotations are the **errata** — 11 462 in ISO 32000-2, 434 strikeouts over 4038 words, and 79 struck passages the conversion still presents as current text. `tools/spec-errata` built, three quotations fixed, 76 passages left to read | — |
