...
| | item | corpus |
|---|---|---|
| [00](00-ambiguous-bucket.md) | Empty the oracle's ambiguous bucket, page by page | 496 pages |
...
| [13](13-a-strikeout-that-does-not-follow-its-text.md) | A `NoZoom` strike-out that no longer spans the words it strikes | 1 |
