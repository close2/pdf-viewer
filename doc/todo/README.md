...
| [05](05-an-instrument-for-the-interactive-surface.md) | An instrument for the interactive surface — the gates measure a raster and the work has moved off it; the design is owed first and ends in an ADR, then one round per instrument |
