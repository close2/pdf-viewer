...
Status: **standing task**, since the hundred-and-seventy-sixth session. **11 names left**, from 754.
Priority: 00 — the last large population where a defect can live without a name
Corpus: 786 ambiguous pages (750 on documents we call complete); **775 diagnosed, 11 held by name**
