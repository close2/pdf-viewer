...
Status: **standing task**, since the hundred-and-seventy-sixth session. **37 names left**, from 754.
Priority: 00 — the last large population where a defect can live without a name
Corpus: 786 ambiguous pages (750 on documents we call complete); **749 diagnosed, 37 held by name**
