...
Status: **standing task**, since the hundred-and-seventy-sixth session. 698 pages left.
Priority: 00 — the last large population where a defect can live without a name
Corpus: 788 ambiguous pages (749 on documents we call complete); 63 diagnosed, 698 held by name
