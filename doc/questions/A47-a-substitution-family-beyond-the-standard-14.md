...
Two downloads. The default download includes the universal font family. Also offer a smaller download without it, named so that it is unmistakable it is the incomplete one: the name should say what is missing and that the download is incomplete, so a person who does not know what to download — or does not care about the size — ends up with the bigger one.