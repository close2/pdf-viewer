//! What is to be drawn.
//!
//! This crate is the device-independent half of raster: a description of marks on a
...
//! different viewport*, and a [`Viewport`] lives in `raster-gpu` for that reason.
//!
//! [`Viewport`]: ../raster_gpu/viewport/index.html
//!
