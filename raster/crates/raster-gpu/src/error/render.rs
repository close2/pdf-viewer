...
pub enum RenderError {
    ...
    /// [`MAX_COORDINATE`](raster_scene::MAX_COORDINATE), the bound the scene boundary
    ...
    ViewportTransformTooLarge {
        ...
        coefficient: f32,
        /// The limit, [`MAX_COORDINATE`](raster_scene::MAX_COORDINATE).
        limit: f32,
    },
    ...
    /// [`Scene::cost`](raster_scene::Scene::cost) can answer it and
    ...
    UnknownFunction {
        /// The identifier that was referenced.
        program: raster_scene::FunctionId,
    },
    /// A [`Paint::Function`](raster_scene::Paint::Function) named a `Range` the program
