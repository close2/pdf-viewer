...
//! `raster-scene` because what they answer is a question about a *shader* — how many `var`s,
...
use raster_scene::{Color, FnRange, Rect};
...
pub const ENTRY_POINT: &str = "raster_function_evaluate";
