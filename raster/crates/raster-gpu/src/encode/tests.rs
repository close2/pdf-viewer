...
fn scene_with_one_rect() -> raster_scene::Scene {
...
/// is what `raster_scene::axis_aligned_rect` recognises and what the analytic lane
/// exists for.
fn store_with_a_rectangle() -> (ResourceStore, raster_scene::OutlineId) {
