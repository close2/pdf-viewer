...
//!
//! Every constant here is either a number the caller's `QUORRA_FEEDBACK.md` section 31 states
...
/// `raster/doc/notes-glyph-phase-carry.md` section 3 records — and **the stroke is not declined at
...
/// `raster/doc/notes-glyph-phase-carry.md` section 2 names in the other axis.
...
///
/// A **stroke**, because `raster_scene::axis_aligned_rect` recognises a rectangle's four
