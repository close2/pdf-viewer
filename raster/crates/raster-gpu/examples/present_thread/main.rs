...
//!
//! ```text
//! xvfb-run -a cargo run -p raster-gpu --example present_thread
//! ```
//!
...
//!
//! ```text
//! env -u WAYLAND_DISPLAY cargo run --release -p raster-gpu --example present_thread
//! ```
//!
...
use raster_gpu::{Device, Layer, Options, PresentCost, Presenter, RenderError, Target, Viewport};
use raster_scene::{Affine, Color, ImageFilter};
...
const TITLE: &str = "raster presenter thread";
