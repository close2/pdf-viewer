...
//!
//! ```sh
//! for a in RADV llvmpipe; do cargo run --release -p raster-gpu --example startup -- "$a"; done
//! cargo run --release -p raster-gpu --example startup -- RADV hoisted
//! ```
//!
...
use raster_gpu::{Device, Options, StartupTimings};
