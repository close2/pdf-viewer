...
use raster_gpu::function::{ENTRY_POINT, OPERATORS, ProgramHash, analyse, generate};
...
// Do not edit: `raster_gpu::function::generate` emits this, and it is a pure
...
/// constant **and** bump `raster_gpu::function::GENERATOR_REVISION` — a persisted pipeline
...
fn the_module_is_the_library_plus_the_function() {
    ...
    assert_eq!(ENTRY_POINT, "raster_function_evaluate");
}
