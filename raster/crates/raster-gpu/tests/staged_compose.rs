...
fn backdrop(builder: &mut SceneBuilder) {
    builder
        .rect(
            raster_scene::Rect::new(Point::new(0.0, 0.0), Point::new(SIZE as f32, SIZE as f32)),
            Affine::IDENTITY,
...
fn half(builder: &mut SceneBuilder) -> Result<raster_scene::MaskId, SceneError> {
