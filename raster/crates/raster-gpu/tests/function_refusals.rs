...
//!
//! `raster/doc/spike-function-paint.md` section 6 states the rule this file exists to keep: **a
//! ground nobody can reach is not a ground.** So there is exactly one test per variant of
