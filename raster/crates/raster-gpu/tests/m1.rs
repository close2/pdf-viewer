...
use raster_gpu::{Device, Options, RenderError, Target, TimingProvenance, Viewport};
use raster_scene::{
...
fn unhonoured_damage_is_reported_not_silent() {
    ...
    assert!(
        frame
            .reports()
            .iter()
            .any(|r| r.kind == raster_gpu::ReportKind::DamageNotHonoured),
