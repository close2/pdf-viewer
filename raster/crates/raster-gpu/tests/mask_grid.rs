...
//! is explicit that only the second is raster's: decoding a packed mask, and **drawing
...
///
/// Its `mask` is a [`MaskId`](raster_scene::MaskId) — §11.5's transparency group, defined
...
///
/// This is the half of hayro #1315 and #2 that is raster's — drawing an image whose grid is
