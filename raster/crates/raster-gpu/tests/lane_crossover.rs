...
//!
//! ```text
//! cargo test --release -p raster-gpu --test lane_crossover -- --ignored --nocapture
//! ```
//!
...
fn lane_crossover_table() {
    ...
    table(Sharing::Distinct, raster_gpu::startup::DEFAULT_ATLAS_BUDGET);
    table(Sharing::Shared, raster_gpu::startup::DEFAULT_ATLAS_BUDGET);
