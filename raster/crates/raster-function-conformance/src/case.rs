...
use raster_scene::function::{FnOp, FnRange};
...
/// hardware (`raster/doc/research-function-paint-arithmetic.md` section 1.7). What a tolerance says
...
/// A ground on which a program is refused before a frame is drawn.
///
/// `raster/doc/spike-function-paint.md` section 6 found these on constructed programs, and
/// principle 6 is why they are refusals rather than approximations. Two of that spike's six grounds
