...
//!
//! The raster developers asked which of the two a named refusal belongs to — "it's a whole page at
...
//!
//! The lane is [`raster_gpu::Coverage::Cpu`], which is what `viewer-ui` draws with below its
