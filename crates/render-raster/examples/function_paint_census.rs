...
//! whose colour is a program, and raster's `Paint::Function` evaluates that program in a
...
//! (raster's ADR 0053, `Agreement::Unbounded`).
//!
...
fn main() {
    ...
    for path in paths() {
        ...
        for index in 0..pages.len() {
            ...
            let paints = raster.last_function_paints();
