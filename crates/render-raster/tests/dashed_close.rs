...
//! 3.133 square units in the quadrant the clause leaves empty, raster 3.086 and vello 2.753 — one
...
///
/// **Measured rather than chosen.** The processor lands within 0.3% of `π` and raster within 1.8%,
