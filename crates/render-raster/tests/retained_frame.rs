...
//!
//! raster owns the other side of this — its own `tests/retained_frame.rs` enumerates what an
...
///
/// **The claim the whole change rests on.** raster measured it on its own archetypes (0 of
...
/// is retained here is a scene this crate built and raster's fixtures are not that scene.
#[test]
...
/// A zoom step misses, which is the case raster says no design can make survive.
#[test]
